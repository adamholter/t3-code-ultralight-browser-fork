...
```bash
npx --yes 'https://github.com/adamholter/t3-code-ultralight-browser-fork/releases/latest/download/t3-code-ultralight-browser-fork.tgz?v=0.51.0' setup --mode iframe --port auto --allow-origin http://localhost:3000 --json
```
...
```bash
npx --yes 'https://github.com/adamholter/t3-code-ultralight-browser-fork/releases/latest/download/t3-code-ultralight-browser-fork.tgz?v=0.51.0' setup --mode custom --delivery hosted --port auto --allow-origin http://localhost:3000 --json
```
...
```bash
npx --yes 'https://github.com/adamholter/t3-code-ultralight-browser-fork/releases/latest/download/t3-code-ultralight-browser-fork.tgz?v=0.51.0' start --allow-origin http://localhost:3000
```
...
```bash
npm install 'https://github.com/adamholter/t3-code-ultralight-browser-fork/releases/latest/download/t3-code-ultralight-browser-fork.tgz?v=0.51.0'
...
Requirements: a currently supported Node.js release (22+) and a working `codex` CLI login. CI runs the full source and packed-consumer checks independently on Node 22, 24, and 26.
